...
<!-- BASIC DATATABLE -->
          <div class="card" style="margin: 0 auto; width: 50%;">
            ...
            <div class="card-body">
              ...
              <video style="width: 100%;" controls src="{{URL::asset('admin/assets/videos/funny.mkv')}}" poster="https://peach.blender.org/wp-content/uploads/title_anouncement.jpg?x11217">

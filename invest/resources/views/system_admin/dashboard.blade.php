                  ...
                  <div class="row mb-5">
                    <div class="col-md-3 col-6">
                      <div class="widget-metric_6 animate">
                        <span class="icon-wrapper custom-bg-yellow"><i class="fa fa-users"></i></span>
                        <div class="right">
                          <span class="value">{{ number_format(count($users)) }}</span>
                    ...
                    <div class="col-md-3 col-6">
                      <div class="widget-metric_6 animate">
                        <span class="icon-wrapper custom-bg-green"><i class="fas fa-check"></i></span>
                        <div class="right">
                          <span class="value">{{ number_format(count($activeUsers)) }}</span>
                    ...
                    <div class="col-md-3 col-6">
                      <div class="widget-metric_6 animate">
                        <span class="icon-wrapper custom-bg-blue3"><i class="fa fa-money"></i></span>
                        <div class="right">
                          <span class="value">{{ number_format($withdrawals,2) }}</span>
                    ...
                    <div class="col-md-3 col-6">
                      <div class="widget-metric_6 animate">
                        ...
                        <div class="right">
                          <span class="value">{{ number_format($spinEarnings,2) }}</span>
                    ...
                    <li>
                      <div class="widget-metric_2">
                        ...
                        <div class="right">
                          ...
                          <span class="value">{{ number_format($survey,2) }}</span>

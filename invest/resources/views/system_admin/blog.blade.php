                ...
                <table id="table" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td ><button onclick="approve({{ $transaction->id }})" class="btn btn-success" style="background: none; color: #5cb85c ;">Approve </button></td>
                      @else
                      <td ><button class="btn btn-success" style="background: none; color: #5cb85c ;">Approved <i class="fa fa-check"></i></button></td>
                      @endif
                    </tr>
                    @endforeach
                  </tbody>

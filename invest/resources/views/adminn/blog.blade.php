...
<head>
  <title>Attention Adverts | My Blogs</title>
  <meta charset="utf-8">
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <div class="container-fluid">
          ...
          <button class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Add <i class="fa fa-plus"></i></button><br>
              <!-- right column -->
              <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="table" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tbody>
                    @foreach($blogs as $transaction)
                    <tr>
                      <td>{{ $transaction->id }}</td>
                      <td>{{ $transaction->title }}</td>
                      <td>{{ $transaction->content }}</td>
                      @if($transaction->status == "Not Approved")
                      <td ><button class="btn btn-danger" style="background: none; color: #d9534f ;">{{ $transaction->status }} <i class="fa fa-close"></i></button></td>
                      @else
                      <td ><button class="btn btn-success" style="background: none; color: #5cb85c ;">{{ $transaction->status }} <i class="fa fa-check"></i></button></td>
                      @endif
                    </tr>
                    @endforeach
                  </tbody>
